...
namespace Microsoft.AspNetCore.Authentication.WsFederation
{
    internal static partial class Resources
    {
        ...
        /// <summary>The service descriptor is missing.</summary>
        internal static string Exception_MissingDescriptor => GetResourceString("Exception_MissingDescriptor");
        /// <summary>No token validator was found for the given token.</summary>
        ...
        /// <summary>The sign in message does not contain a required token.</summary>
        internal static string SignInMessageTokenIsMissing => GetResourceString("SignInMessageTokenIsMissing");
        /// <summary>The sign in message does not contain a required wresult.</summary>
